...
public actor Connection {
  ...
  /// Opens a new connection to RabbitMQ.
  ///
  /// - SeeAlso: [Connection Lifecycle](https://www.rabbitmq.com/docs/connections#lifecycle)
  /// - SeeAlso: [Connection churn](https://www.rabbitmq.com/docs/connections#high-connection-churn)
  /// - SeeAlso: [Connection leaks](https://www.rabbitmq.com/docs/connections#connection-leaks)
